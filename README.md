...
| Distro | Command |
|---|---|
| Debian / Ubuntu / Pop!_OS | `sudo dpkg -i motu-mk5_0.5.4-1_amd64.deb` |
| Fedora / RHEL | `sudo dnf install motu-mk5-0.5.4-1.fc40.x86_64.rpm` |
| Arch Linux | `sudo pacman -U motu-mk5-0.5.4-1-x86_64.pkg.tar.zst` |
